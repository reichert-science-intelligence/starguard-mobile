...
TIMELINE_EVENTS = [
    {
        "date": "02/14/2026",
        "type": "Contact",
        "detail": "Phone outreach - Left voicemail",
        "outcome": "Pending",
    },
    {
        "date": "02/10/2026",
        "type": "Lab",
        "detail": "HbA1c result: 8.2% (Above target)",
        "outcome": "Alert",
    },
    {
        "date": "02/03/2026",
        "type": "Visit",
        "detail": "PCP Office Visit - Dr. Mitchell",
        "outcome": "Completed",
    },
    {
        "date": "01/28/2026",
        "type": "Contact",
        "detail": "Direct mail sent - BCS reminder",
        "outcome": "Delivered",
    },
    {
        "date": "01/15/2026",
        "type": "Gap Closed",
        "detail": "MAD - Medication Adherence confirmed",
        "outcome": "Success",
    },
    {
        "date": "01/08/2026",
        "type": "Contact",
        "detail": "Phone outreach - Spoke with member",
        "outcome": "Success",
    },
]
...
def member_profile_ui():
    ...
    return mobile_page(
        ...
        mobile_card("🏥 Risk & Clinical Summary", ui.output_ui("risk_clinical")),
        # Care Gaps
        mobile_card(
            "📋 Care Gap Status",
        ...
        mobile_card("📅 Intervention Timeline", ui.output_ui("timeline")),
        # Care Team
        mobile_card(
            "👨‍⚕️ Care Team",
        ...
        # Quality Performance
        mobile_card("⭐ Quality Measures Performance", ui.output_ui("quality_performance")),
        # Financial Impact
        mobile_card(
            "💰 Financial Impact",
        ...
        # Communication
        mobile_card("📞 Communication Preferences", ui.output_ui("communication")),
        # SDOH
        mobile_card("🏠 Social Determinants", ui.output_ui("sdoh")),
        # AI Recommendations
        mobile_card(
...
def member_profile_server(input, output, session, get_current_page=lambda: "star"):
            ...
            *[
                ui.div(
                    ...
                    ui.div(
                        ...
                        ui.tags.span(
                            gap["intervention"], style="color: #7c3aed; font-weight: 700;"
                        ),
    ...
    def timeline():
        ...
        type_icons = {"Contact": "📞", "Visit": "🏥", "Lab": "🔬", "Gap Closed": "✅"}
        ...
        return ui.div(
            ...
            ui.div(
                ...
                ui.div(
                    ...
                    ui.tags.span(
                        f"In {pcp['next_visit']} days", style="color: #7c3aed; font-weight: 700;"
                    ),
                    style="padding: 0.5rem 0;",
                ),
                class_="member-profile-card",
    ...
    def financial_impact():
        ...
        return ui.div(
            ...
            ui.div(
                alert_box(
                    "⚠️ High Utilizer Flag: Member exceeds 90th percentile for cost", type="warning"
                )
                if member["high_utilizer"]
                else alert_box("✓ Normal Utilization Pattern", type="success")
            ),
            style="display: flex; flex-direction: column; gap: 0.75rem;",
        )
    ...
    def communication():
        ...
        return ui.div(
            ...
            ui.div(
                ...
                progress_bar(member["response_rate"], label="", color="#28a745"),
    ...
    def sdoh():
        ...
        return ui.div(
            ...
            ui.div(
                ...
                ui.tags.span(
                    sdoh["housing"], style="color: #999; font-weight: 600; font-size: 1.1rem;"
                ),
                style="padding: 0.75rem 0; border-bottom: 1px solid #e0e0e0;",
            ),
            ui.div(
                ...
                ui.tags.span(
                    sdoh["isolation"], style="color: #999; font-weight: 600; font-size: 1.1rem;"
                ),
                style="padding: 0.75rem 0;",
            ),
            ui.div(
    ...
    def ai_recommendations():
        ...
        return ui.div(
            ...
            ui.div(
                ...
                progress_bar(member["closure_probability"], label="", color="#28a745"),
            ...
            # Action button
            ui.div(
                mobile_button("Execute Recommendation", "execute_btn", "primary", icon="🚀"),
                ui.tags.div(
