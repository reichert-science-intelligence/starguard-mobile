...
def hedis_analyzer_ui():
    ...
    avg_gap = sum((m["benchmark"] - m["current_rate"]) for m in HEDIS_MEASURES.values()) / len(
        HEDIS_MEASURES
    )
    ...
    return mobile_page(
        ...
        mobile_card(
            ...
            divider(),
            mobile_button("Analyze Gaps & ROI", "analyze_btn", "success", icon="📈"),
        ),
...
def hedis_analyzer_server(input, output, session, get_current_page=lambda: "hedis"):
    ...
    def measure_overview():
        ...
        return ui.div(
            ...
            progress_bar(
                measure["current_rate"], label=f"{measure['current_rate']}%", color="#7c3aed"
            ),
    ...
    def gap_analysis():
        ...
        if not measure_code or measure_code == "":
            return mobile_card(
                ...
                alert_box(
                    "Please select a HEDIS measure before running the analysis.", type="warning"
                ),
            )
                ...
                *[
                    ui.div(
                        ui.div(
                            ...
                            ui.div(
                                ui.tags.strong(
                                    "New Performance Rate: ",
                                    class_="scenario-label",
                                    style="color: #333;",
                                ),
                                ui.tags.span(
                                    f"{scenario['new_rate']:.1f}%",
                                    class_="scenario-value",
                            ...
                            ui.div(
                                ui.tags.strong(
                                    "Improvement: ", class_="scenario-label", style="color: #333;"
                                ),
                                ui.tags.span(
                                    f"+{scenario['improvement_pct']:.1f}pp",
                                    class_="scenario-value",
                            ...
                            ui.div(
                                ui.tags.strong(
                                    "Effort Level: ", class_="scenario-label", style="color: #333;"
                                ),
                                ui.tags.span(
                                    scenario["effort"],
                                    class_="scenario-value",
                            ...
                            ui.div(
                                ui.tags.strong(
                                    "Timeline: ", class_="scenario-label", style="color: #333;"
                                ),
                                ui.tags.span(
                                    scenario["timeline"],
                                    class_="scenario-value",
