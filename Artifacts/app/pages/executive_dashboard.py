...
from components.mobile_layout import metric_box, mobile_card, mobile_page, progress_bar
...
def executive_dashboard_ui():
    ...
    return mobile_page(
        ...
        mobile_card("Key Performance Indicators", ui.output_ui("kpi_summary")),
        # Top 3 Opportunities
        mobile_card(
        ...
        # System Health
        mobile_card("AI System Health", ui.output_ui("system_health")),
        # Recent Alerts
        mobile_card(
        ...
        # QTD Performance
        mobile_card("Quarter-to-Date Performance", ui.output_ui("qtd_performance")),
    )
...
def executive_dashboard_server(input, output, session, get_current_page=lambda: "star"):
    ...
    def kpi_summary():
        ...
        return ui.div(
            metric_box(
                "Total Members",
                f"{EXECUTIVE_METRICS['total_members']:,}",
                color="#7c3aed",
            ...
            metric_box(
                "High Risk Members",
                f"{EXECUTIVE_METRICS['high_risk_members']:,}",
                color="#dc3545",
                subtitle=f"{(EXECUTIVE_METRICS['high_risk_members'] / EXECUTIVE_METRICS['total_members'] * 100):.1f}% of population",
                dark_labels=True,
            ),
            metric_box(
                "Open Care Gaps",
                f"{EXECUTIVE_METRICS['open_gaps']:,}",
                color="#ff6b00",
            ...
            metric_box(
                "Gaps Closed YTD",
                f"{EXECUTIVE_METRICS['gaps_closed_ytd']:,}",
                color="#28a745",
                subtitle=f"{(EXECUTIVE_METRICS['gaps_closed_ytd'] / (EXECUTIVE_METRICS['gaps_closed_ytd'] + EXECUTIVE_METRICS['open_gaps']) * 100):.1f}% closure rate",
                dark_labels=True,
            ),
    ...
    def top_opportunities():
        ...
        priority_colors = {"Critical": "#dc3545", "High": "#ff6b00", "Medium": "#ffc107"}
            ...
            *[
                ui.div(
                    ui.div(
                        ui.tags.span(
                            opp["measure"],
                            style="font-weight: 700; font-size: 1rem; color: #000000 !important;",
                        ),
                        ui.tags.span(
                            opp["priority"],
    ...
    def system_health():
        ...
        return ui.div(
            metric_box(
                "Model Accuracy",
                f"{EXECUTIVE_METRICS['ai_accuracy']}%",
                color="#28a745",
            ...
            metric_box(
                "System Uptime",
                f"{EXECUTIVE_METRICS['system_uptime']}%",
                color="#7c3aed",
            ...
            metric_box(
                "Active Campaigns",
                f"{EXECUTIVE_METRICS['active_campaigns']}",
                color="#ff6b00",
    ...
    def recent_alerts():
        ...
        alert_colors = {"warning": "#ffc107", "success": "#28a745", "info": "#7c3aed"}

        alert_icons = {"warning": "⚠️", "success": "✅", "info": "ℹ️"}
                ...
                ui.div(
                    ui.div(
                        ...
                        ui.tags.div(
                            ui.tags.div(
                                alert["message"],
                                style="font-weight: 600; color: #666; margin-bottom: 0.25rem;",
                            ),
                            ui.tags.div(
                                alert["action"],
                                style="color: #999; font-size: 0.875rem; font-weight: 500; cursor: pointer;",
                            ),
                            ui.tags.div(
                                alert["time"],
                                style="color: #999; font-size: 0.75rem; margin-top: 0.25rem;",
                            ),
                            style="flex: 1;",
                        ),
    ...
    def qtd_performance():
        ...
        return ui.div(
            ui.div(
                ui.tags.strong(
                    "Revenue Captured",
                    style="color: #000000 !important; font-weight: 700; display: block; margin-bottom: 0.5rem;",
                ),
                ui.tags.div(
                    f"${revenue_captured:,}",
                ...
                progress_bar(
                    capture_rate, label=f"{capture_rate:.1f}% of opportunity", color="#28a745"
                ),
            ...
            ui.div(
                ui.tags.strong(
                    "Gap Closure Rate",
                    style="color: #666; font-weight: 600; display: block; margin-bottom: 0.5rem;",
                ),
                ui.tags.div(
                ...
                progress_bar(
                    gap_closure_rate,
                    label=f"{gaps_closed:,} of {total_gaps:,} gaps closed",
                    color="#7c3aed",
                ),
