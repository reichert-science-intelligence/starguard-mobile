...
HCC_CATEGORIES = [
    ...
    },
    {
        ...
        "avg_weight": 0.288,
        "members": 1307,
        "revenue_impact": 3765000,
    },
    {
        "code": "HCC 23",
        "name": "Other Endocrine/Metabolic/Nutritional",
        "prevalence": 5.8,
        "avg_weight": 0.207,
        "members": 1098,
        "revenue_impact": 2273000,
    },
]
...
MEMBER_SEGMENTS = {
    "Rising Risk": {
        "count": 2847,
        "pct": 15.0,
        "description": "RAF increasing >0.5 in past 6 months",
    ...
    "Stable High Risk": {
        "count": 4126,
        "pct": 21.8,
        "description": "RAF ≥2.0, stable ±0.2 variation",
        "action": "Continue current care management",
        "priority": "Medium",
        "color": "#ff6b00",
    },
    "Stable Medium Risk": {
        "count": 8934,
        "pct": 47.2,
        "description": "RAF 1.0-1.99, stable patterns",
    ...
    "Improving": {
        "count": 1845,
        "pct": 9.7,
        "description": "RAF decreasing >0.3, positive trends",
        "action": "Maintain interventions",
        "priority": "Low",
        "color": "#28a745",
    },
    "Low Risk": {
        "count": 1782,
        "pct": 6.3,
        "description": "RAF <1.0, minimal utilization",
        "action": "Preventive care focus",
        "priority": "Low",
        "color": "#17a2b8",
    },
}
...
def risk_stratification_ui():
    ...
    return mobile_page(
        ...
        mobile_card(
            "HCC-Based Risk Analysis & Revenue Optimization",
            ui.markdown("""
        ...
        mobile_card(
            "Top HCC Categories by Revenue Impact",
        ...
        mobile_card(
            "Member Segmentation by Risk Trajectory",
            ui.output_ui("risk_member_segments"),
...
def risk_stratification_server(input, output, session, get_current_page=lambda: "star"):
    ...
    def risk_portfolio_summary():
        ...
        weighted_raf = (
            sum(cat["count"] * cat["avg_raf"] for cat in RISK_CATEGORIES.values()) / total_members
        )
        total_revenue = sum(
            cat["count"] * cat["revenue_pmpm"] * 12 for cat in RISK_CATEGORIES.values()
        )
        ...
        return ui.div(
            ...
            metric_box(
                ...
                f"{high_risk_pct:.1f}%",
                color="#dc3545",
                subtitle=f"{high_risk_count:,} members",
            ),
                ...
                ui.div(
                    ui.div(
                        ui.tags.div(
                            ui.tags.span(
                                category,
                                style=f"font-weight: 700; font-size: 1.1rem; color: {data['color']};",
                            ),
                            ui.tags.span(
                                data["threshold"],
                                style="color: #666; font-size: 0.875rem; margin-left: 0.5rem;",
                            ),
                            style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;",
                        )
                    ),
                    progress_bar(
                        (data["count"] / total_members) * 100,
                        label=f"{(data['count'] / total_members) * 100:.1f}% ({data['count']:,} members)",
                        color=data["color"],
                    ),
                    ui.div(
                        ui.div(
                            ui.tags.strong("Avg RAF: ", class_="risk-label"),
                            ui.tags.span(
                                f"{data['avg_raf']:.2f}",
                                class_="risk-value",
                        ...
                        ui.div(
                            ui.tags.strong("Revenue PMPM: ", class_="risk-label"),
                            ui.tags.span(
                                f"${data['revenue_pmpm']:,}",
                                class_="risk-value",
                        ...
                        ui.div(
                            ui.tags.small(data["description"], class_="text-muted"),
                            style="padding: 0.5rem 0;",
                        ),
                        style="margin-top: 0.75rem;",
                    ),
                    class_="risk-category-card",
                    style=f"padding: 1.25rem; background: white; border-left: 4px solid {data['color']}; border-radius: 8px; margin-bottom: 1rem;",
                )
                ...
                ui.div(
                    ui.div(
                        ui.tags.span(
                            hcc["code"],
                            class_="hcc-code",
                            style="font-weight: 700; color: #1a1a1a; font-size: 1rem;",
                        ),
                        ui.tags.span(
                            f"{hcc['prevalence']}%",
                            class_="hcc-prevalence",
                            style="font-weight: 600; color: #7c3aed; font-size: 0.875rem;",
                        ),
                    ...
                    ui.div(
                        ui.tags.div(
                            ui.tags.small(
                                "Members: ",
                                class_="hcc-metric-label",
                                style="color: #1a1a1a; font-weight: 600;",
                            ),
                            ui.tags.span(
                                f"{hcc['members']:,}",
                                class_="hcc-metric-value",
    ...
    def risk_hcc_detailed_analysis():
        ...
        return ui.div(
            mobile_card(
                "Complete HCC Category Analysis",
                ui.div(
                    metric_box(
                        "Total HCC Revenue",
                        f"${total_revenue:,.0f}",
                    ...
                    metric_box(
                        "Members with HCCs",
                        f"{total_members_with_hcc:,}",
                        color="#1a1a1a",
                        subtitle="Coded conditions",
                    ),
                ...
                ui.div(
                    *[
                        ui.div(
                            ui.tags.h4(
                                f"{hcc['code']}: {hcc['name']}",
                                style="color: #1a1a1a; margin: 0 0 0.75rem 0; font-size: 1.1rem; font-weight: 700;",
                            ),
                            ui.div(
                                ui.tags.strong(
                                    "Prevalence: ", style="color: #1a1a1a; font-weight: 700;"
                                ),
                                ui.tags.span(
                                    f"{hcc['prevalence']}%",
                                    style="color: #7c3aed; font-weight: 600;",
                            ...
                            ui.div(
                                ui.tags.strong(
                                    "Affected Members: ", style="color: #1a1a1a; font-weight: 700;"
                                ),
                                ui.tags.span(
                                    f"{hcc['members']:,}", style="color: #1a1a1a; font-weight: 600;"
                                ),
                                style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                            ),
                            ui.div(
                                ui.tags.strong(
                                    "RAF Weight: ", style="color: #1a1a1a; font-weight: 700;"
                                ),
                                ui.tags.span(
                                    f"{hcc['avg_weight']:.3f}",
                                    style="color: #1a1a1a; font-weight: 600;",
                            ...
                            ui.div(
                                ui.tags.strong(
                                    "Revenue Impact: ", style="color: #1a1a1a; font-weight: 700;"
                                ),
                                ui.tags.span(
                                    f"${hcc['revenue_impact']:,.0f}",
                                    style="color: #28a745; font-weight: 700; font-size: 1.1rem;",
                                ),
                                style="padding: 0.5rem 0;",
                            ),
            ...
            *[
                ui.div(
                    ui.div(
                        ...
                        ui.tags.span(
                            f"{data['pct']}%",
                            style="font-weight: 600; color: #666; font-size: 0.875rem;",
                        ),
                        style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;",
                    ),
                    ui.div(
                        f"{data['count']:,} members",
                        style="color: #666; font-size: 0.9rem; margin-bottom: 0.75rem;",
                    ),
                    progress_bar(data["pct"], label=f"{data['pct']}%", color=data["color"]),
                    ui.div(
                        ui.div(
                            ui.tags.strong("Description: ", class_="segment-label"),
                            ui.tags.span(
                                data["description"], class_="segment-value", style="color: #555;"
                            ),
                            style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                        ),
                        ui.div(
                            ui.tags.strong("Recommended Action: ", class_="segment-label"),
                            ui.tags.span(
                                data["action"],
                                class_="segment-value",
                                style="color: #7c3aed; font-weight: 600;",
                            ),
                            style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                        ),
                        ui.div(
                            ui.tags.strong("Priority: ", class_="segment-label"),
                            ui.tags.span(
                                data["priority"],
                                class_="segment-value",
                                style=f"color: {'#dc3545' if data['priority'] == 'High' else '#ffc107' if data['priority'] == 'Medium' else '#28a745'}; font-weight: 600;",
                            ),
                            style="padding: 0.5rem 0;",
                        ),
                        style="margin-top: 0.75rem;",
    ...
    def risk_revenue_opportunity():
        ...
        return ui.div(
            ui.div(
                ui.tags.h3(
                    "Annual Revenue Optimization Potential",
                    style="color: #7c3aed; text-align: center; margin: 0 0 1rem 0; font-size: 1.25rem;",
                ),
                ui.tags.div(
                    f"${total_opportunity:,.0f}",
                    style="font-size: 3rem; font-weight: 700; color: #28a745; text-align: center; margin-bottom: 1.5rem;",
                ),
            ...
            ui.div(
                ui.tags.h4(
                    "Rising Risk Intervention Program",
                    style="color: #000000 !important; margin: 0 0 0.75rem 0; font-size: 1rem; font-weight: 700;",
                ),
                ui.div(
                    ui.tags.strong(
                        "Target Population: ", style="color: #1a1a1a; font-weight: 700;"
                    ),
                    ui.tags.span(
                        f"{rising_risk['count']:,} members",
                        style="color: #7c3aed; font-weight: 600;",
                    ),
                    style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                ),
                ui.div(
                    ui.tags.strong(
                        "Intervention Strategy: ", style="color: #1a1a1a; font-weight: 700;"
                    ),
                    ui.tags.span(
                        "Proactive care management, condition monitoring",
                ...
                ui.div(
                    ...
                    ui.tags.span(
                        "$150 PMPM risk mitigation", style="color: #333; font-weight: 600;"
                    ),
                    style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                ),
                ui.div(
                    ui.div(
                        ui.tags.strong(
                            ...
                            style="color: #999; font-weight: 600; display: block; margin-bottom: 0.5rem;",
                        ),
                        ui.tags.span(
                            f"${rising_risk_opportunity:,.0f}",
                            style="color: #999 !important; font-weight: 700 !important; font-size: 1.5rem; display: block;",
                        ),
            ...
            ui.div(
                ...
                ui.div(
                    ...
                    ui.tags.span(
                        f"{MEMBER_SEGMENTS['Low Risk']['count']:,} members",
                        style="color: #7c3aed; font-weight: 600;",
                    ),
                    style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                ),
                ...
                ui.div(
                    ui.tags.strong("Expected Value: ", style="color: #1a1a1a; font-weight: 700;"),
                    ui.tags.span(
                        "$25 PMPM prevention value", style="color: #333; font-weight: 600;"
                    ),
                    style="padding: 0.5rem 0; border-bottom: 1px solid #e0e0e0;",
                ),
                ui.div(
            ...
            alert_box(
                "💡 Targeting high-risk and low-risk members with tailored interventions maximizes both quality outcomes and revenue optimization.",
                type="info",
            ),
        )
