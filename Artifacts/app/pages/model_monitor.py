...
from components.mobile_layout import divider, metric_box, mobile_card, mobile_page, progress_bar
...
def model_monitor_ui():
    ...
    return mobile_page(
        ...
        # Model components
        mobile_card("Model Component Status", ui.output_ui("model_components")),
        # Feature importance
        mobile_card(
        ...
        # Validation tests
        mobile_card("✓ Validation Test Results", ui.output_ui("validation_tests")),
        # Model updates
        mobile_card(
        ...
        # System health
        mobile_card("System Health Indicators", ui.output_ui("system_health")),
    )
...
def model_monitor_server(input, output, session, get_current_page=lambda: "star"):
    ...
    def overall_performance():
        ...
        return ui.div(
            ...
            metric_box(
                "Recall", f"{MODEL_METRICS['recall']}%", color="#0066cc", subtitle="Sensitivity"
            ),
            metric_box(
                "F1 Score",
    ...
    def model_components():
        ...
        status_colors = {"Optimal": "#28a745", "Monitor": "#ffc107", "Alert": "#dc3545"}
            ...
            *[
                ui.div(
                    ...
                    ui.div(
                        ...
                        ui.tags.div(
                            ui.tags.span(
                                "Avg Confidence: ", style="color: #666; font-size: 0.875rem;"
                            ),
                            ui.tags.span(
                                f"{component['avg_confidence']:.1f}%",
                                style="color: #7c3aed; font-weight: 600; font-size: 0.875rem;",
                            ),
                        ),
                        style="padding: 0.75rem 0; border-bottom: 1px solid #e0e0e0;",
            ...
            *[
                ui.div(
                    ...
                    ui.tags.div(
                        ui.tags.strong(
                            "Impact: ",
                            style="color: #000000 !important; font-size: 0.875rem; font-weight: 700;",
                        ),
                        ui.tags.span(
                            update["impact"],
                            style="color: #000000 !important; font-weight: 900; font-size: 1rem;",
                        ),
                    ),
    ...
    def system_health():
        ...
        return ui.div(
            ...
            ui.div(
                ui.tags.strong(
                    "Data Drift Score: ", style="color: #666 !important; font-weight: 700;"
                ),
                ui.tags.span(
                ...
                ui.tags.div(
                    ...
                    ui.tags.span(" (Threshold: 0.05)", style="color: #666; font-size: 0.875rem;"),
                    style="margin-top: 0.5rem;",
                ),
